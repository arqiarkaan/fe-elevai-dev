...
const features = [
  {
    ...
    description:
      'Generator prompt untuk membuat video dengan AI seperti Google Veo.',
    isPremium: false,
  },
  {
    id: 'prompt-enhancer',
...
export const DailyToolsFeatures = ({
  searchQuery,
  isPremium,
  onFeatureClick,
}: FeaturesProps) => {
    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Peralatan harian untuk membantu produktivitas dan kreativitas Anda.
        </p>
      </div>
